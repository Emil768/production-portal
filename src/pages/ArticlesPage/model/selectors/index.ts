...
export const getArticlesPageSelector = (state: StoreSchema) => state?.articlesPage?.page;
...
export const getArticlesSearchSelector = (state: StoreSchema) => state?.articlesPage?.search || '';

export const getArticlesOrderDataSelector = (state: StoreSchema) => state?.articlesPage?.order || 'asc';

export const getArticleSortDataSelector = (state: StoreSchema) => state?.articlesPage?.sort || ArticleSortField.CREATED;

export const getArticleTypeDataSelector = (state: StoreSchema) => state?.articlesPage?.type || ArticleType.ALL;
