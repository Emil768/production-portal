...
export const getArticleRecommendations =
    articleRecommendationAdapter.getSelectors<StoreSchema>(
        (state) =>
...
const articleDetailsRecommendationSlice = createSlice({
    ...
    initialState:
        articleRecommendationAdapter.getInitialState<ArticleDetailsRecommendationSchema>(
            {
                isLoading: false,
                error: undefined,
                ids: [],
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(
                fetchRecommendationArticles.fulfilled,
